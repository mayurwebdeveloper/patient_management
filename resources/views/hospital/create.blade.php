...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form method="post" action="{{ route('add-hospital') }}" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
            <div class="form-group col-md-6">
                <label for="name">Hospital Name.</label>
                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{old('name')}}" placeholder="Hospital Name">
                @error('name')
