...
<script>
    ...
    $.ajax({
            url: "{{ route('doctor-edit', ['id' => '']) }}/" + id, // Pass the id here
            type: "GET",
            success: function (data) {
                ...
                var specialities = data.user.specialities;

                console.log(specialities)

                var specialityIds = specialities.map(function(speciality) {
                ...
                $('#specialities option').each(function() {
...
<div class="card shadow mb-4">
    <div class="card-header py-3" id="table-card-title">
        ...
        <div>
            @can('add doctor')
            <button class="btn btn-info" id="addUser" data-toggle="modal" data-target="#userModal"><i class="fas fa-plus"></i></button>
            @endcan
    ...
    <div class="modal-content">
      ...
      <form action="{{ route('doctor-save') }}" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="specialities" class="col-form-label">Speciality:</label>
            <select name="specialities[]" id="specialities" class="form-control" required multiple>
                @foreach ($speciality as $specialty)
